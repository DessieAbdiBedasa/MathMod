...
subtitle: "Модель боевых действий - вариант 42"
...
В начальный момент времени страна $X$ имеет армию численностью 111111 человек, 
а в распоряжении страны $Y$ армия численностью в 99999 человек.
...
$$
 \begin{cases}
	\frac{dx}{dt}= -0.33x(t) - 0.77y(t) + sin(t+11)
	\\   
	\frac{dy}{dt}= -0.44x(t) - 0.66y(t) + cos(t+11)
 \end{cases}
$$
...
$$
 \begin{cases}
	\frac{dx}{dt}= -0.33(t) - 0.77y(t) + sin(22t)
	\\   
	\frac{dy}{dt}= -0.22x(t)y(t) - 0.88y(t) + cos(22t)
 \end{cases}
$$
